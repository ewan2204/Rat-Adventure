...
class Capsule {
	...
	/**
	 * Function to computer bounding box of a capsule and set the bounding box.
	 * Nieve assumes capsule is vertical.
	 */
	computeBoundingBox (){
		let min = new Vector3(this.start.x - this.radius, this.start.y, this.start.z - this.radius);
		let max = new Vector3(this.start.x + this.radius, this.end.y  , this.start.z + this.radius);
